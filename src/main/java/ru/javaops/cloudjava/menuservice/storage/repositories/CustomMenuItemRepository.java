...
public interface CustomMenuItemRepository {
    ...
    int updateMenu(Long id, UpdateMenuRequest dto); // обновление блюда

    List<MenuItem> getMenusFor(Category category, SortBy sortBy); // получение списка блюд для конкретной категории
}
